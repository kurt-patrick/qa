...
namespace KPE.Se.Common
{
    ...
    public abstract class PageTestBase
    {
        ...
        // OS
        public const string OS_Windows_10 = "Windows 10";
        public const string OS_Windows_8_1 = "Windows 8.1";
        public const string OS_Windows_8 = "Windows 8";
        public const string OS_Windows_7 = "Windows 7";
        public const string OS_Windows_XP = "Windows XP";
        public const string OS_Windows_Linux = "Linux";

        // Grid Providers
        public const string GridProvider_None = "none";
        public const string GridProvider_SauceLabs = "saucelabs";
        public const string GridProvider_BrowserStack = "browserstack";
